// Resumenes de los temas del sistema de misiones (backup/historical/*.json).
// Clave = id numerico del tema (coincide con el prefijo del archivo en backup/historical).
// personajes: ids de CharactersModule que participaron y siguen teniendo cuenta activa hoy;
// se recalcula dinamicamente contra el registro de personajes, no es un valor fijo.
// interrogado: solo se completa en temas de tipo "interrogatorio"; el nombre vive solo en
// este campo, nunca repetido dentro del resumen (asi lo puede mostrar aparte el render).
// resumen: puede nombrar a cualquier personaje que NO haya sido jugado en esa escena
// (victimas, sospechosos, figuras del canon, etc.) - solo los personajes efectivamente
// jugados/roleados en el tema (los de "personajes", y el interrogado si es el caso) se
// mantienen anonimos, para evitar metagaming sobre que cuenta participo.
// tag: copia del campo "tagged" de la mision correspondiente en bwdata.js (MissionsModule),
// cruzado por titulo en minuscula (la clave del objeto "missions" == tema.toLowerCase()).
// Sirve para saber a que capitulo/arco de guide.js pertenece el resumen.
const _historical = {
  "351": {
    ...
    "personajes": ['/u78', '/u8'],
    "interrogado": null,
    "resumen": 'La investigación giró en torno a la autopsia conjunta de Edwin Merrythought, Morgana Dempsey y Sirius Black II, hallados muertos la misma madrugada en circunstancias que apuntaban a un asesinato múltiple cuidadosamente orquestado. El examen reveló que Edwin presentaba daños físicos externos —costillas astilladas y pulmones colapsados— provocados por un hechizo de impacto; que Morgana mostraba signos de estrangulamiento violento con fracturas en el cuello, descartándose que se tratara de una maldición de fuego al no hallarse quemaduras, lo que apuntó en cambio a una agresión física directa y personal; y que Sirius, sin heridas visibles, había muerto envenenado por una toxina animal desconocida que le provocó necrosis generalizada y un colapso cardiovascular. Un análisis de sangre confirmó que Sirius era de sangre pura mientras que Edwin y Morgana eran mestizos. Entre las pertenencias de Morgana se halló una pulsera infantil grabada con un nombre, que una visión mágica reveló perteneciente a otra niña que jugaba junto a ella —entonces también una niña—, sin que se lograra determinar su identidad. La comunicación con los espíritus de los fallecidos permitió recoger fragmentos de sus últimos instantes: palabras de cariño de Edwin hacia sus hijos, una advertencia de Morgana al nigromante sobre el velo entre la vida y la muerte, y su pedido de ser enterrada bajo la luna llena. Pese a confirmarse que los tres murieron exactamente a la misma hora, la identidad del responsable y el significado de varias de las pistas quedaron sin resolver al cierre de la jornada.',
  },
  "353": {
    ...
    "interrogado": null,
    "resumen": 'La investigación tuvo lugar en el castillo ancestral de la familia de Sirius Black II, en busca de pistas sobre su asesinato. En el estudio se confirmó que el cuerpo había sido hallado en un sillón, inconsciente, sin la varita que solía llevar siempre consigo, y se detectó que varios libros habían sido retirados recientemente de la pequeña biblioteca privada, junto con runas de protección recién talladas en el mobiliario. En las cocinas, las botellas de licor permanecían selladas y sin usar. En el invernadero se descubrió una sección privada, accesible solo para la familia, donde faltaba una planta de una de las macetas: la elfa doméstica Lixie reveló que el propio Sirius Black II había ordenado envolverla para regalarla poco antes de morir, y que luego le borraron la memoria para que no pudiera decir de qué especie se trataba. En la sala del árbol genealógico se constató que tres familiares —Phineas Nigellus II Black, Marius Black y Cedrella Black— habían sido borrados del linaje por distintos motivos. En la biblioteca se halló, oculto tras un antiguo reloj, un pasadizo con una chimenea de red flu no registrada. Además, se descubrió que una anciana pariente, dada por muerta hacía décadas, permanecía encerrada y oculta en una de las torres del castillo, sumida en un evidente estado de demencia senil. La investigación cerró sin identificar al responsable, aunque las pistas apuntaban a que el culpable conocía bien la propiedad y contaba con el permiso o la confianza de Sirius Black II para entrar en ella.',
  },
  "354": {
    ...
    "personajes": ['/u50', '/u55'],
    "interrogado": null,
    "resumen": 'La investigación tuvo lugar en la vivienda de Edwin Merrythought, antiguo jefe del Departamento de Seguridad Mágica, asesinado junto a otros dos candidatos, en busca de pistas sobre el responsable de los crímenes. En el estudio se encontró un sobre de contenido personal sin relevancia para el caso y un cuadro de una constelación al que le faltaban dos estrellas, borradas recientemente con magia. En el dormitorio apareció un antiguo escudo, regalo de Galatea Merrythought, que al ser examinado con un hechizo reveló un cuaderno escondido en su interior. Dentro solo había crucigramas de un periódico, con seis páginas marcadas cuyas respuestas resultaron ser constelaciones; al unir sus iniciales se formó una palabra que confirmó que ese cuaderno era una copia falsa, dejada como señuelo. Entre esas mismas pistas surgió el nombre de Galatea Merrythought, la familiar que había regalado el escudo y antigua profesora de Hogwarts, señalada como quien podría conservar el cuaderno auténtico. Pese a revisar la casa por completo, la varita del fallecido nunca fue hallada, y la investigación concluyó sin dar con el cuaderno original, dejando a Galatea Merrythought como el siguiente rastro a seguir.',
  },
  "365": {
  ...
  "561": {
    ...
    "personajes": ['/u78', '/u8'],
    "interrogado": null,
    "resumen": 'La investigación se desarrolló en el archivo de fallecidos de un hospital mágico, revisando expedientes de defunción relacionados con la familia de Morgana Dempsey, una de las candidatas asesinadas. Entre legajos aparentemente ajenos, los investigadores hallaron el certificado de Merlina Dempsey, hermana menor de la víctima, muerta décadas atrás en un supuesto ataque de licántropo, pero la hora de fallecimiento registrada en el certificado no coincidía con la del informe de ingreso, indicio de que algo había sido ocultado. Los demás expedientes de la misma carpeta pertenecían a personas sin relación con el caso, unidas solo por compartir las iniciales de Merlina Dempsey, y todo apuntaba a que había sido la propia Morgana Dempsey, empleada de ese archivo, quien los fue reuniendo con los años como parte de una investigación personal sobre la muerte de su hermana. Recortes de prensa firmados siempre por la misma periodista, Greta Thimble, revelaron que Brian Dempsey, padre de ambas, había sido detenido por impedir el auxilio médico a la niña y que, además, abastecía de whiskey de fuego a Morgana Dempsey y a los otros dos candidatos ya fallecidos, Edwin Merrythought y Sirius Black II; tiempo después, Brian Dempsey e Iris Dempsey aparecieron muertos en su vivienda tras un incendio que los investigadores consideraron provocado para encubrir algo más. Al cierre de la pesquisa quedó confirmado que la muerte de Merlina Dempsey fue sospechosa, quedando pendiente determinar qué ocultaba realmente la familia Dempsey y si su historia se conecta con los asesinatos de los candidatos.',
  },
  "562": {
    ...
    "personajes": ['/u8', '/u17'],
    "interrogado": null,
    "resumen": 'La investigación consistió en rastrear, a través de los registros del Departamento de Transporte Mágico, los viajes realizados por una chimenea oculta vinculada a la residencia de Sirius Black, mago recientemente asesinado. Los registros revelaron que, en los días previos a su muerte, Sirius se había reunido en secreto y a horas inusuales con la Ministra de Magia, Wilhelmina Tuft, y, por separado, con Morgana Dempsey y Edwin Merrythought, dos rivales suyos en una contienda de poder, llegando los tres a coincidir bajo su mismo techo en una ocasión. También constaba que, pocos días antes, había salido de su vivienda para entregar en un destino desconocido una maceta con una planta no identificada, viaje que, como otro de los registros consultados, permanecía bajo clasificación oficial y resistió todo intento de revelarlo mediante hechizos. Con esta información quedó establecido que Wilhelmina Tuft y los otros implicados mantenían tratos ocultos con Sirius Black cuyo motivo aún se desconoce, restando interrogarlo para esclarecerlo.',
  },
  "563": {
    ...
    "personajes": ['/u9', '/u8'],
    "interrogado": null,
    "resumen": 'La investigación se llevó a cabo en un invernadero controlado de una reserva natural, donde los presentes trabajaron sobre una planta arrancada de raíz y hallada en relación con el asesinato de Sirius Black. La maceta indicaba que se trataba de un ejemplar de tamaño mediano que requería cuidados frecuentes, y los huecos en la tierra, junto con el uso de guantes gruesos para su extracción, sugerían que era una planta tóxica. Mediante una serie de hechizos de herbología orientados a restaurar el sol, la humedad, el riego y los nutrientes del suelo, lograron regenerar la planta hasta devolverla a su estado completo, revelando que se trataba de acónito. Con ello quedó resuelto uno de los misterios en torno al caso, aunque permaneció sin aclarar si esa planta había sido el medio empleado para asesinar a los candidatos.',
  },
  "643": {
    ...
    "personajes": ['/u9', '/u17'],
    "interrogado": null,
    "resumen": 'La investigación llevó a los descendientes de Sirius Black hasta un estudio secreto oculto en su castillo ancestral, protegido por runas y un intrincado acertijo de aritmancia. Tras superar las defensas, hallaron una rama seca de acónito que señalaba un compartimento con tres expedientes: los de Aidan Flamel, profesor de herbología, y Theolonius Covey, un vidente. Los documentos revelaban que Sirius Black había reunido información comprometedora sobre cada uno —un hijo ilegítimo, un estatus de sangre oculto y una ascendencia pura escondida bajo un cambio de apellido— para forzarlos a firmar contratos a cambio de dinero, la donación de un invernadero familiar y una recomendación para un ascenso en un hospital. Los contratos figuraban cerrados sin que constara la entrega de las recompensas prometidas, dejando abierta la duda de si Sirius Black pretendía cumplir su palabra o si el chantaje nunca tuvo intención de saldarse. Los papeles hallados quedaron en poder de los investigadores, con libertad para decidir qué información compartir con las autoridades.',
  },
  "644": {
    "tema": 'Faded Lineage',
    "fecha": '1952-11-18',
  ...
  "660": {
    ...
    "resumen": 'El interrogatorio, de carácter narrativo, se desarrolló en el castillo ancestral de la familia Black, donde se buscó obtener información de la anciana viuda de Phineas Nigellus Black —con la mente deteriorada por la edad— sobre la muerte de su hijo, Sirius Black II, en el marco de la investigación por el fallecimiento de varios candidatos a un alto cargo del Ministerio. Entre recuerdos confusos y momentos de lucidez, la mujer relató que Elleanora, una vidente cercana a la familia, movida por los celos, calló durante años una advertencia que solo reveló demasiado tarde, y que la madre de esta última había pronunciado una maldición sobre el nombre Sirius Black, condenando a quien lo llevara a morir a manos de su propia sangre. Contó además que Phineas, tras dar con la verdad de aquella profecía años atrás, descubrió que su propio hermano —muerto de niño tras confirmarse que carecía de magia— había sido asesinado a sangre fría por su propio padre, un acto que en su momento se consideró correcto pero que lo destruyó para siempre. Antes de poder profundizar más, la anciana volvió a sumirse en la confusión, aunque los interrogadores lograron extraer información considerada valiosa para el caso.',
  },
  "661": {
    ...
    "interrogado": null,
    "resumen": 'La investigación se centró en la vivienda de Fergus Vance, un nigromante ya fallecido, en busca de pistas sobre un posible encubrimiento. En un baúl familiar apareció un cofre cerrado que escondía una caja rúnica con un relicario y dos sobres. Uno contenía una autorización de San Mungo para aplicar un procedimiento de supresión de memoria y empatía a Delyth Kova, una paciente internada contra su voluntad, junto con una nota de Morgana Dempsey advirtiéndole que sabía que había ayudado a esa paciente a escapar bajo una identidad falsa. El otro sobre contenía dos contratos de donación de una misma propiedad: primero recibida por Vance y, siete años después, cedida por él a Morgana. Quedó así confirmado que Vance ayudó a Kova a huir de un tratamiento no consentido y que, tiempo después, fue silenciado por Morgana a cambio de esa propiedad.',
  },
  "662": {
    "tema": 'Green To Blue',
    "fecha": '1952-11-24',
  ...
  "664": {
    ...
    "interrogado": null,
    "resumen": 'La investigación se centró en un cementerio mágico, donde descansaban los miembros de la familia Dempsey, bajo sospecha de haber encubierto una muerte falsa. Al abrir las tumbas correspondientes, los investigadores hallaron que todas estaban vacías: la de Merlina Dempsey no contenía resto alguno, lo que confirmó que seguía con vida, mientras que las de Brian e Iris Dempsey, también vacías, correspondían efectivamente a los cuerpos reanimados que debieron enfrentar y derrotar antes de poder revisarlas. Durante la exploración, el espíritu de Wenn Wraithwood, una exfuncionaria del Departamento de Seguridad Mágica, se dejó ver y advirtió, de forma críptica, que ya era demasiado tarde, justo antes de que se escuchara una explosión proveniente de la tumba de la familia Denman, destruida deliberadamente. Al acudir al lugar, alcanzaron a ver de forma fugaz a Nina Wraithwood, con capa oscura, que tras llevarse algo consigo se desapareció, dejando además inconsciente al guardia del cementerio. La misión concluyó confirmando que Merlina Dempsey seguía con vida, y dejó nuevas pistas sobre un posible crimen y documentación adulterada vinculada a personas al margen de la ley.',
  },
  "665": {
  ...
  "753": {
    ...
    "interrogado": null,
    "resumen": 'La investigación se llevó a cabo en el archivo de estudiantes de un colegio de magia, durante las vacaciones de invierno, con el objetivo de dar con el paradero de un familiar perdido de una de las integrantes del grupo, entregado en su momento a una familia muggle. Revisando los registros de ingreso correspondientes al año de nacimiento estimado, los investigadores hallaron un error en el listado: un alumno llamado Findlay McCrory, registrado como mestizo, era, según un profesor que lo conocía, en realidad hijo de muggles. Al examinar su expediente encontraron documentación inusual, entre ella una prueba de paternidad de origen muggle con alta probabilidad de coincidencia respecto al padre pero sin muestra materna, y una autorización legal firmada por el abuelo del menor en calidad de tutor, lo que sugería la ausencia del padre. Con estos elementos, el grupo concluyó que Findlay McCrory era, con gran probabilidad, el familiar perdido que buscaban, aunque quedó pendiente confirmarlo mediante una conversación directa con él o una prueba de sangre.',
  },
  "833": {
    "tema": 'Ancestral Code',
    "fecha": '1953-01-12',
  ...
  "838": {
    ...
    "interrogado": null,
    "resumen": 'La investigación se centró en el cuerpo entregado como el de Wrenn Wraithwood, una de las gemelas Wraithwood dadas por fallecidas, además de los registros clínicos y familiares que pudieron reunirse sobre ella y su hermana Nina Wraithwood. El examen forense arrojó contradicciones entre el estado del cadáver y las circunstancias de la muerte que constaba en los registros, lo que llevó a aplicar diversos hechizos de rastreo e identificación. Estos revelaron que el cuerpo no correspondía a quien se creía, sino que había sido desenterrado y alterado para sustituir al examinado anteriormente, ocultando así un cambio deliberado. Con ello quedó confirmado que Wrenn Wraithwood, quien se daba por fallecida, sigue con vida, aunque los motivos detrás del intercambio de cuerpos, las muertes fingidas y su paradero actual permanecen sin esclarecer.',
  },
  "847": {
    ...
    "resumen": 'El interrogatorio buscó esclarecer la relación entre un alquimista y Sirius Black II, con quien había mantenido un contrato cancelado, así como determinar si guardaba alguna conexión con la profecía asociada a este. El interrogado negó conocerlo o haber tenido trato con él, y explicó su vínculo con la familia de videntes que lo había acogido. Al someterlo a un hechizo de revisión de memoria, el auror a cargo descubrió un vacío de poco más de una hora en sus recuerdos correspondientes al día de la muerte de Sirius Black II, que coincidía exactamente con la visita de este a la vivienda familiar, sin poder determinar su causa ni su contenido. Durante el proceso, el interrogado pronunció además, de forma involuntaria, una nueva profecía, que quedó registrada por los inefables presentes. El interrogatorio se cerró sin establecer una relación directa entre ambos, quedando como principal hallazgo ese vacío de memoria sin explicación.',
  },
  "931": {
  ...
  "934": {
    ...
    "interrogado": null,
    "resumen": 'La investigación reabrió el expediente de una redada ocurrida meses atrás, luego de que Wrenn Wraithwood —la mujer registrada como fallecida en aquel operativo— o su hermana Nina Wraithwood fuera sorprendida profanando una tumba en un cementerio. Al revisar los archivos, se confirmó que la redada original había buscado detener a un supuesto filtrador de secretos que entregaba información del Ministerio a gobiernos extranjeros y a autoridades muggles. Sin embargo, el testimonio directo de uno de los aurores presentes reveló que tal filtrador nunca existió: en realidad, dos nigromantes ilegales, identificados como Yusuf Lochlan y Vinnie Grayson, mantenían cautiva a una veela a la que explotaban para obtener información, dato que había sido deliberadamente omitido de los informes oficiales para proteger su identidad tras sacarla del país. Además, quien había realizado el peritaje forense confirmó que su informe original era correcto —alguien había muerto por un hechizo explosivo autoinfligido—, pero que Nina Wraithwood había mentido al identificar el cuerpo de su hermana, dejando abierta la sospecha de que la muerte pudo haber sido simulada con ayuda de esos mismos nigromantes. La sesión terminó sin resolver por completo el caso, pero con nuevas pistas que reabren la pregunta de qué ocurrió realmente aquella noche.',
  },
  "983": {
    ...
    "interrogado": null,
    "resumen": 'La misión requirió infiltrarse en los ensayos de una banda itinerante de trovadores en una taberna para obtener, a cambio de una contraseña y de sobornos, información sobre los Denman, una familia cuyo verdadero apellido era Rosier, caída en la magia oscura. Los cánticos revelaron que el padre, Aurelius, vendió a su hija Wilhelmina para saldar una deuda, y que esta, tiempo después, delató a sus propios hermanos, Valerian y Zeke: este último, que había intentado burlar a la muerte practicando nigromancia bajo el alias de Morian y el apellido Wraithwood, terminó sufriendo el beso del dementor tras ser rastreado gracias a un rastro de sangre dejado en sus rituales prohibidos. Wilhelmina borró todo rastro de su apellido original y quedó asociada a la persecución de la magia oscura, llegando a ser conocida como Wilhelmina Tuft, ex Ministra de Magia. Se supo también que las hijas gemelas de Zeke, Wrenn y Nina Wraithwood, que decían vivir en el extranjero, en realidad permanecían escondidas practicando robos y magia oscura movidas por la venganza: Wrenn murió a manos de sus propios acreedores tras contratar a alguien para un robo del que luego se quedó con el objeto prohibido, mientras que Nina, nacida sin magia, se convirtió en un espíritu errante de naturaleza aún incierta. También se obtuvo el origen de un anillo forjado con hueso que permite comunicarse con los muertos. Como precio final por lo revelado, el grupo debió elegir y beber de un cáliz entre siete, distinguiendo mediante conocimientos propios cuál resultaba inofensivo mientras los demás ocultaban efectos que iban del dolor físico a la pérdida de memoria, de voluntad o de control mágico.',
  },
  "984": {
    ...
    "resumen": 'La investigación se centró en interrogar al guardián de un cementerio mágico, incapacitado durante el robo de un anillo extraído de la tumba de la familia Denman, con el fin de determinar si contaba con información adicional sobre lo sustraído. Durante el proceso se confirmó que se trataba de un squib de poco más de veinte años, registrado como tal ante el Ministerio de Magia. La revisión de sus recuerdos estableció que había sido golpeado por la espalda al ingresar a su cabaña, sin llegar a ver a su agresor, aunque los investigadores ya sospechaban que se trataba de Wrenn Wraithwood; la verificación de sus palabras confirmó que, pese a los nervios de verse rodeado por tantas personas, colaboró con sinceridad en todo momento. Aun así, el interrogatorio no arrojó ninguna pista adicional sobre la identidad de los responsables ni sobre el destino del objeto robado.',
  },
  "1008": {
  ...
  "1110": {
    ...
    "resumen": 'El interrogatorio se centró en los contratos hallados en el estudio de Sirius Black II, que llevaron a citar al profesor de herbología vinculado a ellos. Este confirmó haber sido contratado meses antes de la muerte de Black para desarrollar una poción experimental que revirtiera o controlara la licantropía, tras superar una prueba con veritaserum; para ello recibió acónito y el veneno de una criatura oriunda de Brasil. El contrato, iniciado en abril, fue cancelado unilateralmente en agosto, poco antes del asesinato. El profesor reveló además haber colaborado bajo presión, luego de que Black descubriera la existencia de un hijo ilegítimo de su padre, y accedió a entregar a los aurores toda la correspondencia relacionada para reconstruir la cronología de los hechos.',
  },
  "1170": {
    ...
    "resumen": 'El interrogatorio tuvo lugar en una granja aislada y fuertemente protegida mágicamente, donde un grupo de aurores localizó a la hermana menor de Morgana Dempsey, la sanadora recién asesinada: una mujer a la que se creía muerta desde la infancia, tras haber sido atacada por un licántropo y ocultada por su propia familia bajo una identidad falsa. Al enterarse de la muerte de su hermana y de Edwin Merrythought, un amigo cercano a ambas, se negó a colaborar y terminó atrapada dentro de las mismas defensas que protegían la propiedad, aceptando responder solo a cambio de que no volvieran a visitarla. Contó su historia personal y la amistad que unía a su hermana con Merrythought, quienes, según relató, investigaban en secreto, junto a Black, algo que consideraban peligroso. Quedó confirmado que las protecciones del lugar no eran obra de su hermana sino de Amaya Flamel, otra allegada con conocimientos de sanación, y que los tres implicados habían viajado juntos hasta un faro la madrugada previa a su muerte.',
  },
  "1171": {
    "tema": 'Stolen Shroud',
    "fecha": '1953-03-20',
  ...
  "1205": {
    ...
    "interrogado": null,
    "resumen": 'La misión llevó al grupo a la vivienda abandonada de Mabel Merrythought, herbóloga fallecida años atrás, cuyo jardín trasero había sido devorado por un cultivo de mandrágoras mutadas en ejemplares gigantescos y letales. Tras atravesar ese jardín esquivando sus chillidos mortales y cruzar hasta un cobertizo oculto entre las plantas, descubrieron que en realidad se trataba de un despacho secreto perteneciente a Edwin Merrythought, fallecido ex jefe del departamento de seguridad. Allí encontraron un muro de investigación astrológica dedicado a anticipar peligros para los aurores, frascos de pociones sin identificar y una caja de cartas intercambiadas con Morgana Dempsey y Sirius Black, ambos encontrados muertos poco después de su último encuentro con Edwin. La correspondencia revelaba un intento arriesgado y finalmente descartado de desarrollar protección para los aurores mediante transfiguración de piel, además de referencias a una profecía inquietante sobre una fuerza oscura que amenazaba con arrasarlo todo. La investigación quedó abierta, con los viales pendientes de análisis y la cronología de los últimos contactos entre los fallecidos solo parcialmente reconstruida.',
  },
  "1235": {
    "tema": 'In Search Of The Deadly Hallows',
    "fecha": '1953-03-30',
    "tipo": 'investigacion',
    "tag": ['sirius', 'capitulo 0','wave'],
